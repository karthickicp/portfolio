          ...
          {MY_PROJECTS.map((project, index) => (
            ...
            >
              <div className="pl-[30px] pr-[10px] lg:px-[60px] relative z-10 case-study-desc">
                <p className="font-medium tracking-space-24 uppercase mb-3 opacity-70">
                  {project.category}
                </p>
                ...
                <div className="hidden items-center case-study w-full transition-opacity duration-1000 lg:flex">
                  <a
                    href={project.link ?? "#"}
                    target="_blank"
                    className="testimonial-role me-3 font-bold"
                  >
                    {project.hoverText}
                  </a>
              ...
              <img
                src={project.img}
                alt="work"
                className={`${project.imgClass} absolute bottom-0`}
                loading="lazy"
              />
            </div>
          ))}
