...
export const TopSection = () => {
  return (
    <div className="wrapper topSec relative h-screen">
      ...
      <h1 className=" text-[17.5vw] 3xl:text-[18.75rem] text-white -z-10 font-extrabold leading-[17.5rem] text-center top-0 drop-shadow-[0_30px_100px_rgba(0,0,0,0.08)] relative">
