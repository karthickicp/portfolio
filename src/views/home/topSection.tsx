        ...
        <div className="container h-full">
          <div className="flex flex-col-reverse h-full descSec md:flex-row 2xl:relative">
            <div className="flex-1 self-center xl:self-end">
              ...
              <p className="text-paragraph para-text leading-7 mb-6 lg:mb-[130px]">
            ...
            <div className="relative flex-1 flex justify-end topsec-img -z-10 self-center xl:self-baseline xl:translate-y-[50px] 2xl:absolute 2xl:right-0 2xl:bottom-0">
