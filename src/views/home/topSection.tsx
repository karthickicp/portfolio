        ...
        <div className="container h-full">
          <div className="flex flex-col-reverse items-center h-full descSec md:flex-row xl:items-end 2xl:relative">
            <div className="flex-1">
              ...
              <p className="text-paragraph para-text text-4 leading-7 lg:text-[22px] lg:leading-9 mb-6">
            ...
            <div className="relative flex-1 flex justify-end topsec-img xl:translate-y-[100px] 2xl:absolute 2xl:right-0 2xl:bottom-[-45px]">
              <img
                src={profilePicture}
                alt="profile-picture"
                // className="max-h-[700px] lg:max-h-[100%]"
              />
