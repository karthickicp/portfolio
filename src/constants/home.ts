export const MY_PROJECTS = [
  {
    ...
    title: `Appointment Scheduler - Responsive Website Design`,
    bg: "#142B48",
  ...
  {
    category: "e-commerce",
    title: `Mio Amore - Online Cake Order Mobile App`,
    bg: "#931880",
